    ...
    <div class="login-form-area mg-t-30 mg-b-40">
        <div class="container">
            <div class="row">
                ...
                <form action="<?php echo base_url('login/aksi_login'); ?>" method="post" id="adminpro-form" class="adminpro-form">
                    <div class="col-lg-4">
                        <div class="login-bg">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4">
                                    <div class="login-button-pro">
                                        <button onclick="location.href='<?php echo base_url();?>register'" class="login-button login-button-rg">Register</button>
...
<?php
    ...
    else redirect(base_url('welcome'));
?>
